...
#define MOTOR_MAX_RPM 96                   // motor's max RPM          
#define MAX_RPM_RATIO 0.85                  // max RPM allowed for each MAX_RPM_ALLOWED = MOTOR_MAX_RPM * MAX_RPM_RATIO          
#define MOTOR_OPERATING_VOLTAGE 12          // motor's operating voltage (used to calculate max RPM)
#define MOTOR_POWER_MAX_VOLTAGE 12          // max voltage of the motor's power source (used to calculate max RPM)
#define MOTOR_POWER_MEASURED_VOLTAGE 12     // current voltage reading of the power connected to the motor (used for calibration)
#define COUNTS_PER_REV1 1662              // wheel1 encoder's no of ticks per rev
#define COUNTS_PER_REV2 -1689              // wheel2 encoder's no of ticks per rev
...
// MOTOR PINS
  ...
  #define MOTOR1_IN_A 0 // Pin no 21 is not a PWM pin on Teensy 4.x, you can use pin no 1 instead.
  #define MOTOR1_IN_B 1 // Pin no 20 is not a PWM pin on Teensy 4.x, you can use pin no 0 instead.
